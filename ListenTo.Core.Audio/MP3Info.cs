...
namespace ListenTo.Core.Audio
{
	...
	public class MP3Info
	{
		...
		public bool ReadMP3Information(string FileName)
		{
			...
			GetFileNameFromFileStream(fs);
			
			bool isOk = ReadMP3Information((System.IO.Stream)fs);
		...
		private void GetFileNameFromFileStream(System.IO.FileStream stream)
		{
			// Set the filename not including the path information
			strFileName = @stream.Name;
		...
		public bool ReadMP3Information(System.IO.Stream fs)
		{
