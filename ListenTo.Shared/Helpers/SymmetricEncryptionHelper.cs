...
{
    public class SymmetricEncryptionHelper: IEncryptionHelper
    {
        static private Byte[] m_Key = new Byte[8];
        static private Byte[] m_IV = new Byte[8];
        public IBase64EncodeHelper Base64EncodeHelper { get; set; }
        ...
        public string EncryptData(String strKey, String strData)
        {
            ...
            //4. Encrypt the Data
            byte[] rbData = System.Text.Encoding.UTF8.GetBytes(strData);
            ...
            {
                strResult = Base64EncodeHelper.ToBase64String(mOut.ToArray());
            }
            return strResult;
        }
        ...
        public string DecryptData(String strKey, String strData)
        {
            ...
            try
            {
                bPlain = Base64EncodeHelper.FromBase64String(strData);
            }
            catch (Exception)
            {
            ...
            try
            {
                ...
                strResult = System.Text.Encoding.UTF8.GetString(mOut.GetBuffer());
